...
const zh = {
  'brand.subtitle': 'notes, projects & unfinished thoughts',
  ...
  'footer.builtBefore': '由', 'footer.builtAfter': '构建',
  'social.mobileKicker': '其他地方', 'social.mobileTitle': '也可以在这些地方找到我',
  'home.viewAll': '查看全部',
  'archive.count': '共 {count} 篇内容',
  'resume.link': '简历',
  'notFound.kicker': '404 / Not found', 'notFound.title': '页面未找到', 'notFound.heading': '这里暂时没有内容。', 'notFound.body': '链接可能已经移动，或者这个想法还没写完。', 'notFound.back': '返回首页',
  'post.kicker': 'Writing / {tag}', 'post.words': '{count} 字', 'post.reading': '约 {count} 分钟',
...
const en = {
  ...
  'footer.builtBefore': 'Built with', 'footer.builtAfter': '',
  'social.mobileKicker': 'Elsewhere', 'social.mobileTitle': 'Find me elsewhere',
  'home.viewAll': 'View all',
  'archive.count': '{count} entries',
  'resume.link': 'Résumé',
  'notFound.kicker': '404 / Not found', 'notFound.title': 'Page not found', 'notFound.heading': 'Nothing lives here yet.', 'notFound.body': 'The address may have changed, or this note has not been written.', 'notFound.back': 'Back home',
  'post.kicker': 'Writing / {tag}', 'post.words': '{count} words', 'post.reading': 'About {count} min',
